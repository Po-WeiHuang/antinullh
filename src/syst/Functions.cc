...
namespace antinufit
{
  ...
  double OscProb(const ParameterDict &params, const std::vector<double> &obs_vals)
  {
    ...
    Double_t baseline = 100;
    // indexDistance[obs_vals.at(0)];
  ...
  double OscProbLightSterile(double baseline, double nuEnergy, double fDmSqr21, double fSSqrTheta12,double fDmSqr01, double fSSqrTheta01){
    ...
    fOscProb = 1 - 4*( fSSqrTheta01*fCSqrTheta12*fCSqrTheta13*fCSqrTheta13*fCSqrTheta01*fCSqrTheta12*Sqrs_01 
                    +  fSSqrTheta01*fCSqrTheta12*fCSqrTheta12*fCSqrTheta13*fCSqrTheta13*Sqrs_02
                    +  fCSqrTheta01*fCSqrTheta12*fSSqrTheta12*fCSqrTheta13*fCSqrTheta13*Sqrs_12
                    +  fSSqrTheta13*fCSqrTheta13*Sqrs_13);
    return fOscProb;
  }
}
